...
SELECT '=== Create Company Dimension tables For Company Mart  ===' AS info;
...
SELECT '=== Create Job Title Short Dimension For Company Mart  ===' AS info;
...
SELECT '=== Create Job Title Dimension For Company Mart  ===' AS info;
...
SELECT '=== Create Location Dimension For Company Mart  ===' AS info;
...
SELECT '=== Create Month-level Dimension For Company Mart  ===' AS info;
...
SELECT '=== Create Company to Location For Company Mart  ===' AS info;
...
SELECT '=== Create Job Title Short to Job Title For Company Mart  ===' AS info;
...
SELECT '=== Create fact table - fact_company_hiring_monthly  For Company Mart  ===' AS info;
